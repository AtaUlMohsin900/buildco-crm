        ...
        columnHelper.accessor('id', {
            ...
            cell: (info) => (
                <div className="font-medium text-gray-900 dark:text-gray-100">
                    <Link to={`/estimates/${info.getValue()}`} className="hover:text-primary-600 dark:hover:text-primary-400">
                        {info.getValue()}
                    </Link>
                </div>
            ),
        ...
        columnHelper.display({
            ...
            cell: (info) => (
                <div className="flex items-center space-x-2">
                    ...
                    <Link to={`/estimates/edit/${info.row.original.id}`} className="p-1 text-gray-500 hover:text-primary-600 transition-colors">
                        <FiEdit2 size={18} />
                    </Link>
